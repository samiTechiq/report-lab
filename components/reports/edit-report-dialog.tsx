...
export function EditReportDialog({ report }: EditReportDialogProps) {
	...
	const nextFormStep = () => {
		setCurrentStep((prev) =>
			prev < formSteps.length - 1 ? prev + 1 : prev
		);
	};
					...
					<>
						...
						<div>
							...
							<input
								type="number"
								className="input-control"
								{...form.register("each_kg_produced", {
									valueAsNumber: true,
								})}
								required
							/>
					...
					<>
						...
						<div>
							...
							<input
								type="number"
								className="input-control"
								{...form.register("additional_stock", {
									valueAsNumber: true,
								})}
								required
							/>
			...
			<Dialog open={open} onOpenChange={setOpen}>
				<DialogContent className="sm:w-full max-w-[500px]">
					<DialogHeader>
						...
						<DialogDescription>
							Make changes to the report here. Click save when
							you're done.
						</DialogDescription>
					</DialogHeader>
